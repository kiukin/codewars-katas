...
# by chance from the start, the value of the old car is bigger 
# than the value of the new one or equal there is no saving to be made, 
...
def nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth):
    ...
    reminder = (saving + priceOld) - priceNew
    return [month, round(reminder)]
