# Kata: Hands up
# https://www.codewars.com/kata/56d8f14cba01a83cdb0002a2/solutions/python
...
# Firstly, a person raises 1 hand; then they raise the second hand; 
# after that they put both hands down - these steps form a cycle
# Person #1 performs these steps all the time, person #2 advances only after 
# person #1 puts their hands down, and person #3 advances only after 
# person #2 puts their hands down
