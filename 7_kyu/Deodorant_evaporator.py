...
# the percentage of foam or gas lost every day (evap_per_day) and the threshold (threshold) in 
# percentage beyond which the evaporator is no longer useful. All numbers are strictly positive.
...
# math.ceil(math.log(threshold/100, 1 - evap_per_day/100))